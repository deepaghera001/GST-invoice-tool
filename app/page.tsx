    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1">
            <div className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-slate-100">
              <span className="text-xs font-medium text-slate-500 mr-2">Calculators</span>
              <Link href="/gst-calculator" className="text-sm text-slate-700 hover:text-slate-900 hover:bg-white px-2 py-1 rounded transition-colors">
                GST
              </Link>
              <Link href="/tds-calculator" className="text-sm text-slate-700 hover:text-slate-900 hover:bg-white px-2 py-1 rounded transition-colors">
                TDS
              </Link>
            </div>
            <div className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-slate-100 ml-2">
              <span className="text-xs font-medium text-slate-500 mr-2">Documents</span>
              <Link href="/invoice" className="text-sm text-slate-700 hover:text-slate-900 hover:bg-white px-2 py-1 rounded transition-colors">
                Invoice
              </Link>
              <Link href="/salary-slip" className="text-sm text-slate-700 hover:text-slate-900 hover:bg-white px-2 py-1 rounded transition-colors">
                Salary
              </Link>
              <Link href="/rent-agreement" className="text-sm text-slate-700 hover:text-slate-900 hover:bg-white px-2 py-1 rounded transition-colors">
                Rent
              </Link>
            </div>
          </nav>
        ...
        <div className="container mx-auto px-4 py-16 md:py-20">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Calculate GST/TDS penalties and generate professional business documents. 
      ...
      <section className="py-12 bg-slate-50">
        <div className="container mx-auto px-4 space-y-8">
          <div className="flex items-center justify-between max-w-4xl mx-auto">
            <div>
              <h3 className="text-xl font-semibold text-slate-900">Penalty Calculators</h3>
              <p className="text-sm text-slate-600">Free tools for GST and TDS compliance</p>
            </div>
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {tool.features.map((feature) => (
                          <div key={feature} className="flex items-center gap-1.5 text-xs text-slate-500 bg-slate-50 px-2 py-1 rounded">
      ...
      <section className="py-12 bg-white border-t border-slate-200">
        <div className="container mx-auto px-4 space-y-8">
          <div className="flex items-center justify-between max-w-4xl mx-auto">
            <div>
              <h3 className="text-xl font-semibold text-slate-900">Document Generators</h3>
              <p className="text-sm text-slate-600">Professional PDFs for your business needs</p>
            </div>
      ...
      <section className="py-12 bg-slate-50 border-t border-slate-200">
        <div className="container mx-auto px-4 space-y-8">
          <div className="max-w-4xl mx-auto text-center">
            <h3 className="text-xl font-semibold text-slate-900">Penalty Quick Reference</h3>
            <p className="text-sm text-slate-600 mt-1">Current rates as per GST Act and Income Tax Act</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-5 max-w-4xl mx-auto">
            ...
            <Card className="border-slate-200 bg-white">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-base font-medium text-slate-900">GST Late Filing</CardTitle>
                  <Badge variant="outline" className="text-xs">Section 47 & 48</Badge>
                </div>
              </CardHeader>
              <CardContent className="space-y-3">
            ...
            <Card className="border-slate-200 bg-white">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-base font-medium text-slate-900">TDS Late Filing</CardTitle>
                  <Badge variant="outline" className="text-xs">Section 234E</Badge>
                </div>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="space-y-2 text-sm">
      ...
      <footer className="border-t border-slate-200 bg-white mt-auto">
        <div className="container mx-auto px-4 py-10">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              <h4 className="font-medium text-slate-900 mb-3 text-sm">Calculators</h4>
            ...
            <div>
              <h4 className="font-medium text-slate-900 mb-3 text-sm">Documents</h4>
              <ul className="space-y-2">
          ...
          <div className="border-t border-slate-200 pt-6 text-center">
            <p className="text-xs text-slate-500">
              © 2025 ComplianceKit. Calculations are for estimation purposes. Consult a CA for official advice.
            </p>
          </div>
        </div>
      </footer>
